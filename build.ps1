<#
.SYNOPSIS
makeOrders Build Script
#>

Write-Host "========================================" -ForegroundColor Cyan
Write-Host "makeOrders Build Script" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "[3/4] Building (This may take several minutes)..." -ForegroundColor Yellow
...
# Find the exe file in dist directory
...
Write-Host "2. Ensure templete.xlsx is in the root directory"
Write-Host "3. Put templete.xlsx in root directory"
Write-Host "4. Put order xlsx files in 店小秘导出订单表\"
Write-Host "5. Results will be in 工具输出工厂单 folder"
Write-Host ""
